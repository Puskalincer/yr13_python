    ...
    with ui.tab_panel('A'):
        ...
        def on_click1():
            ...
            if catagory_menu.value == 1:
                select.set_visibility(False)
            if catagory_menu.value == 2:
                select.set_visibility(True)
        ...
        with ui.row().style('display:flex;align-items: center;'):
            catagory_menu = ui.toggle({1: 'Any' , 2: 'Main', 3 :'Entertainment' , 4: 'Science'}, value=1)
        ...
        toggle2 = ui.toggle({1: 'any', 2 :'easy' , 3: 'medium', 4: 'hard'},value=1)
        toggle4 = ui.toggle({1: 'any', 2 :'mulitple choice' , 3: 'true/false'},value=1)
